...
public class LaserBeam : MonoBehaviour {
	...
	void LateUpdate() {
        ...
        if (laserOn) {
            ...
            RaycastHit2D hit = Physics2D.Raycast(rayInstantiatePos.position, direction, raySize, enemyHitLayer); 
            ...
            if (hit.collider != null) {
                ...
                if (hit.collider.tag == "PlayerTag") {
                    Debug.Log("hit");
                    hit.collider.gameObject.GetComponent<PlayerController>().TakeDamage(laserDamage);
                }
                /*------------------------------------------------------ */
            }
    ...
    ///</summary>
    public void FireLaser(bool start) {
